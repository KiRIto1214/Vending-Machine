...
HD_PWD='C:/Users/NISHANT SHARMA/vending_machine/vending_machine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vending_modify.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vending_modify.tcl
