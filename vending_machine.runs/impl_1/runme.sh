...
HD_PWD='C:/Users/NISHANT SHARMA/vending_machine/vending_machine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vending_modify.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vending_modify.tcl -notrace
